<template>
  <div class="body-bg">
    ...
    <div class="grammar-config">
      <div class="grammar-config-container">
        <h1 class="heading">Identify Subject & Predicate</h1>
        <form class="grammar-config-form" @submit.prevent="submitForm">
